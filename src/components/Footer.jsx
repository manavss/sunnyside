function Footer() {
  return (
    <footer className="  bg-footerBg flex w-full flex-col items-center justify-center gap-y-10 py-14 font-Barlow  text-cyanGraphicDesignText">
      <h1 className=" text-5xl font-extrabold">sunnyside</h1>
